...
public class ExceptionDemoController {
  ...
  public void throwBusiness() {
    throw new BusinessException(
        ErrorCode.BAD_REQUEST, "Regla de negocio incumplida.", HttpStatus.BAD_REQUEST);
  }
  ...
  public void throwI18nKey() {
    ...
    throw new BusinessException(
        ErrorCode.BAD_REQUEST, "error.business.default", HttpStatus.BAD_REQUEST);
  }

  /**
   * Muestra que si el texto NO es una clave, se devuelve tal cual (personalización total del
   * cliente).
   */
  ...
  public void throwCustomMessage() {
    throw new BusinessException(
        ...
        "Este es un mensaje totalmente personalizado que no está en los properties.",
        HttpStatus.BAD_REQUEST);
  }
  ...
  public void throwClientKey() {
    // 'sample.error.limit_reached' está definido en
    // sample-project/src/main/resources/messages.properties
    throw new BusinessException(
        ErrorCode.FORBIDDEN, "sample.error.limit_reached", HttpStatus.FORBIDDEN);
  }
}
