...
/**
 * Demuestra escenarios donde la librería envuelve automáticamente las
 * respuestas exitosas.
 * Todas las respuestas (excepto String y byte[]) se envuelven en un objeto
 * ApiResponse.
 */
@RestController
...
public class StandardResponseController {
    ...
    /**
     * Respuesta simple de un objeto DTO.
     * Se convertirá en { "success": true, "data": { ... }, "timestamp": "..." }
     */
    @GetMapping("/object")
    ...
    /**
     * Demostración de respuesta CRUDA (String).
     * Los tipos básicos como String no se envuelven por diseño (ResponseAdvice
     * exclusion).
     */
    @GetMapping("/raw")
