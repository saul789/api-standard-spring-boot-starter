...
/**
 * Service dedicated to creating and enriching standardized ProblemDetail responses. Implements
...
public class ProblemDetailService {
  ...
  private URI extractCustomType(Exception ex) {
    ...
    ProblemType annotation =
        AnnotatedElementUtils.findMergedAnnotation(ex.getClass(), ProblemType.class);
    if (annotation != null) {
      try {
