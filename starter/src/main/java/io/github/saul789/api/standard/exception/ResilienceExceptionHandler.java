 ...
 * This advice is only active if Resilience4j is present on the classpath.
 * It is ordered before GlobalExceptionHandler to take precedence.
 */
...
public class ResilienceExceptionHandler {
    ...
    public ProblemDetail handleCallNotPermittedException(CallNotPermittedException ex, HttpServletRequest request, Locale locale) {
    ...
    public ProblemDetail handleRateLimitingExceptions(Exception ex, HttpServletRequest request, Locale locale) {
        return problemDetailService.createProblem(
