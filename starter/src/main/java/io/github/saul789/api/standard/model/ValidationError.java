 ...
 *
 * <p>Instances are embedded in a {@code ProblemDetail} under the
 * {@code "errors"} extension property whenever a validation exception
 * (e.g. {@link jakarta.validation.ConstraintViolationException}) is handled.
 */
