...
class GlobalExceptionHandlerTest {
  ...
  void setUp() {
    ...
    java.util.List<ProblemDetailEnricher> enrichers =
        java.util.List.of(new StandardMetadataEnricher(), new TraceIdEnricher());
    this.problemDetailService = new ProblemDetailService(messageSource, properties, enrichers);
    this.globalExceptionHandler =
        new GlobalExceptionHandler(this.messageSource, this.problemDetailService);
    this.mockMvc =
  ...
  static class TestController {
    ...
    public void constraint() {
      ...
      when(violation.getPropertyPath())
          .thenReturn(
              org.hibernate.validator.internal.engine.path.PathImpl.createPathFromString("email"));
  ...
  void shouldHandleGenericException() throws Exception {
    mockMvc
        .perform(MockMvcRequestBuilders.get("/generic"))
  ...
  void shouldHandleGenericExceptionDirectly() {
    ...
    ProblemDetail result =
        globalExceptionHandler.handleGenericException(ex, request, Locale.ENGLISH);
  ...
  void shouldHandleConstraintViolationWithDetails() throws Exception {
    mockMvc
        .perform(MockMvcRequestBuilders.get("/constraint"))
  ...
  void shouldDirectlyHandleNoResourceFound() {
    ...
    ProblemDetail detail =
        globalExceptionHandler.handleNoResourceFoundException(ex, request, Locale.ENGLISH);
  ...
  void shouldHandleValidationExceptionWithI18n() {
    ...
    ProblemDetail detail =
        globalExceptionHandler.handleValidationException(ex, request, Locale.ENGLISH);
  ...
  void shouldHandleConstraintViolationWithMalformedTemplate() {
    ...
    ProblemDetail result =
        globalExceptionHandler.handleConstraintViolation(ex, request, Locale.ENGLISH);
  ...
  void shouldHandleResponseStatusException() {
    ...
    ProblemDetail result =
        globalExceptionHandler.handleResponseStatusException(ex, request, Locale.ENGLISH);
  ...
  void shouldHandleMediaTypeNotSupportedException() {
    ...
    ProblemDetail result =
        globalExceptionHandler.handleMediaTypeNotSupported(ex, request, Locale.ENGLISH);
  ...
  void shouldHandleMethodNotAllowedException() {
    ...
    ProblemDetail result =
        globalExceptionHandler.handleMethodNotAllowed(ex, request, Locale.ENGLISH);
  ...
  void shouldHandleProblemException() {
    ...
    ProblemDetail result =
        globalExceptionHandler.handleProblemException(ex, request, Locale.ENGLISH);
  ...
  void shouldCoverAllProblemExceptionConstructors() {
    ...
    assertNotNull(
        new ProblemException(
            ErrorCode.BAD_REQUEST, "msg", HttpStatus.BAD_REQUEST, "http://custom.com"));
    ...
    assertNotNull(
        new ProblemException(
            ErrorCode.BAD_REQUEST, "msg", HttpStatus.BAD_REQUEST, (java.net.URI) null));
    ...
    assertNotNull(
        new BusinessException(ErrorCode.BAD_REQUEST, "msg", HttpStatus.BAD_GATEWAY, "detail"));
    ...
    assertNotNull(
        new ProblemException(ErrorCode.BAD_REQUEST, "msg", HttpStatus.BAD_REQUEST, (String) null));
  }
  ...
  void shouldHandleProblemTypeProviderException() {
    ...
    ProblemDetail result =
        globalExceptionHandler.handleGenericException(
            new ProviderException(), request, Locale.ENGLISH);
  ...
  void shouldHandleAnnotatedProblemTypeException() {
    ...
    ProblemDetail result =
        globalExceptionHandler.handleGenericException(new AnnotatedEx(), request, Locale.ENGLISH);
    assertEquals("http://annotated.com", result.getType().toString());
  }

  @Test
  void shouldHandleProblemDetailServiceReflection() throws Exception {
    java.lang.reflect.Method resolveType =
        ProblemDetailService.class.getDeclaredMethod(
            "resolveType", String.class, java.net.URI.class);
  ...
  void shouldHandleExtractCustomTypeEdgeCases() throws Exception {
    java.lang.reflect.Method extractType =
        ProblemDetailService.class.getDeclaredMethod("extractCustomType", Exception.class);
  ...
  void shouldHandleInvalidTypeOverrideGracefully() {
    ...
    ProblemDetail result =
        pds.createProblem(
            HttpStatus.BAD_REQUEST, request, "detail", "BAD_REQUEST", null, Locale.ENGLISH);
  ...
  void shouldHandleStatusReasonPhraseFailure() {
    ...
    ProblemDetailService pds =
        new ProblemDetailService(messageSource, new ApiStandardProperties(), List.of());
    ProblemDetail result =
        pds.createProblem(status, request, "detail", "INTERNAL_ERROR", null, Locale.ENGLISH);
  ...
  void shouldHandleValidTypeOverrideInService() {
    ...
    props
        .getErrors()
        .setTypeOverrides(java.util.Map.of("CUSTOM_CODE", "http://valid-override.com"));
    ProblemDetailService pds = new ProblemDetailService(messageSource, props, List.of());
    ProblemDetail result =
        pds.createProblem(
            HttpStatus.BAD_REQUEST, request, "detail", "CUSTOM_CODE", null, Locale.ENGLISH);
